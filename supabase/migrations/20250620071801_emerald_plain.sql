/*
  ...
  1. Security Updates
    - Update RLS policies for courses and problems to allow admin operations
    - Add proper admin checks for content creation
    - Ensure maheshch1094@gmail.com has full admin access

  2. Admin Access
    - Allow admins to create, update, and delete courses
    - Allow admins to create, update, and delete problems
