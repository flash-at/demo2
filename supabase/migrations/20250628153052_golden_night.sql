...
CREATE TABLE IF NOT EXISTS redemption_requests (
  ...
  redemption_type text NOT NULL CHECK (redemption_type IN ('cash', 'gift_voucher', 'paypal', 'bank_transfer', 'crypto')),
...
-- RLS policies for redemption_requests - drop existing first to avoid conflicts
